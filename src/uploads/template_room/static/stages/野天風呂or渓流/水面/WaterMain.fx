...
float m_fR : CONTROLOBJECT < string name = "WaterLightController_v5.pmx"; string item = "フォグ赤"; >;
float m_fG : CONTROLOBJECT < string name = "WaterLightController_v5.pmx"; string item = "フォグ緑"; >;
float m_fB : CONTROLOBJECT < string name = "WaterLightController_v5.pmx"; string item = "フォグ青"; >;
float m_lR : CONTROLOBJECT < string name = "WaterLightController_v5.pmx"; string item = "ライト赤"; >;
float m_lG : CONTROLOBJECT < string name = "WaterLightController_v5.pmx"; string item = "ライト緑"; >;
float m_lB : CONTROLOBJECT < string name = "WaterLightController_v5.pmx"; string item = "ライト青"; >;

float m_Fog : CONTROLOBJECT < string name = "WaterLightController_v5.pmx"; string item = "深度フォグ"; >;
float m_Mirror : CONTROLOBJECT < string name = "WaterLightController_v5.pmx"; string item = "鏡面強さ"; >;

float m_UpDown : CONTROLOBJECT < string name = "WaterLightController_v5.pmx"; string item = "上下幅"; >;
float m_Strength : CONTROLOBJECT < string name = "WaterLightController_v5.pmx"; string item = "水面荒さ"; >;
float3 WLC_Pos : CONTROLOBJECT < string name = "WaterLightController_v5.pmx";string item = "位置調整用";>;
